...
public class ClashRoyaleGUI extends JFrame{
   ...
   /**
    ...
    private void prepareActions(){
        ...
        buttonAdd.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent ev){
                ...
                catch (ClashRoyaleException cre)
                {
                    cre.printStackTrace();
                }                    
            }
    ...
    private void  actionAdd() throws ClashRoyaleException {
    ...
    private void actionSearch(){
        ...
        if (patronBusqueda.length() > 0) {
            try{
                ...
                if(answer.trim().isEmpty() || answer.contains("No existe el mazo/carta")) {
                    answer = "No se econtraron cartas o mazos con la letra indicada. ";
                }
            } catch (Exception e){
                manejarError(e, "No se pudo realizar la busqueda. Verifique la busqueda del mazo.");
            }
        }
    ...
    private void manejarError(Exception e, String mensajeUsuario){
        JOptionPane.showMessageDialog(this, mensajeUsuario, "Error en la busqueda del mazo", JOptionPane.ERROR_MESSAGE);
        Log.record(e);
    }
