...
public class Card extends Thing{
    ...
    public int elixir() throws ClashRoyaleException{
       if (elixir == null) throw new ClashRoyaleException(ClashRoyaleException.ELIXIR_UNKNOWN);
       if ((elixir <1) || (10<elixir)) throw new ClashRoyaleException(ClashRoyaleException.ELIXIR_ERROR);
       return elixir;
    }    
    ...
    public int resistance() throws ClashRoyaleException{
       if (hitPoints == null) throw new ClashRoyaleException(ClashRoyaleException.RESISTANCE_UNKNOWN);
       if ((hitPoints !=0) && (hitPoints<100) || (5000 < hitPoints)) throw new ClashRoyaleException(ClashRoyaleException.RESISTANCE_ERROR);
       return hitPoints;
    }  
